...
//                                                                                  
// CatWare   ac_fft_dif_r2pX_bfp_inpl  is  C_view  of  fft_dif_r2pX_bfp_inpl_core it
// works as C++  wrapper  around generic C Core class 'fft_dif_r2pX_bfp_inpl_core'. 
// 'fft_dif_r2pX_bfp_inpl_core'instantiate butterfly as                             
// 'fft_dif_r2pX_bfp_inpl_butterfly'and Compute FFT Flow Graph fetching and writing 
...
//                                                                                  
//                                                                                  
// 'fft_dif_r2pX_bfp_inpl_butterfly'                                                
...
#ifndef __AC_FFT_DIF_R2PX_BFP_INPL_H
#define __AC_FFT_DIF_R2PX_BFP_INPL_H
...
template < int N_FFT, int RADX, int DIF_D_P, int DIF_D_I, class fix_p, class com_p, class complex_round, class rnd_ext, class com_rnd_ext, class com_mult, class com_tw > class fft_dif_r2pX_bfp_inpl_butterfly
{
  /*
...
class fft_dif_r2pX_bfp_inpl_core
{
  /*
...
#pragma unroll yes
  ...
  ac_int<ac::log2_ceil < RADIX >::val, 0> dynRangeCompute (cx_dType butffinp[RADIX]) {
    ...
    static ac_int<logRx, 0> dynamic_last;
    static int  counter;
#pragma unroll yes
...
#include <twiddles_64bits.h>
     ...
     */
    fft_dif_r2pX_bfp_inpl_butterfly < N_FFT, RADIX, DIF_D_P, DIF_D_I, dType, cx_dType, cx_dround, b_dround, cx_b_dround, cx_mType, cx_tType > btrfly;
...
template < int N_FFT, int RADIX, int ORDER, int TWIDDLE_PREC, int DIF_D_P, int DIF_D_I, class out_struct > class ac_fft_dif_r2pX_bfp_inpl
{
private:
  typedef ac_fixed < DIF_D_P, DIF_D_I, true > dif_fxp_data;
  typedef ac_complex < dif_fxp_data > dif_input, dif_output;

  fft_dif_r2pX_bfp_inpl_core < N_FFT, RADIX, ORDER, TWIDDLE_PREC, DIF_D_P, DIF_D_I > fft;
...
#pragma hls_design interface
  void CCS_BLOCK(run)(ac_channel < dif_input > &inst, ac_channel < out_struct > &outst) {
    void coverAssert ();
